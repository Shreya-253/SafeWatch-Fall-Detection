...
window_name = "SafeWatch - Possible Fall Detection"
...
print("SafeWatch fall detection started.")
    ...
    while True:
        ...
        if possible_fall:
            ...
            print(
                ...
                f"Saving alert image: {alert_image_path}"
            )
        ...
        cv2.putText(
            resized_frame,
            f"Angle: {torso_angle:.1f} | Body ratio: {body_ratio:.2f}",
            (15, 172),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.42,
            (255, 255, 255),
        ...
        cv2.putText(
            resized_frame,
            f"Horizontal confirmation: {horizontal_after_upright_count}/20",
            (15, 195),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.40,
            (255, 255, 255),
        ...
        cv2.putText(
            resized_frame,
            "Green: pose | Purple: torso | Q: Quit",
            (15, 218),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.38,
            (255, 255, 255),
        ...
        if possible_fall and alert_image_path:
            ...
            print(f"Alert image saved with banner: {alert_image_path}")
