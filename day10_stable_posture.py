...
window_name = "SafeWatch - Day 10 Stable Posture"
...
frame_number = 0
last_landmarks = None
posture_history = deque(maxlen=posture_history_size)
stable_posture = "UNKNOWN"

print("Day 10 started.")
...
with vision.PoseLandmarker.create_from_options(options) as landmarker:
    while True:
        ...
        if last_landmarks:
            ...
            hip_y_ratio = hip_midpoint[1] / target_height
            ...
            if posture_history.count("UPRIGHT") >= 5:
                stable_posture = "UPRIGHT"
            elif posture_history.count("HORIZONTAL") >= 5:
        ...
        if stable_posture == "UPRIGHT":
            ...
            stable_color = (0, 165, 255)

        cv2.putText(
            resized_frame,
            f"Stable posture: {stable_posture}",
            (15, 30),
        ...
        cv2.putText(
            resized_frame,
            f"Angle: {torso_angle:.1f} | Width/Height: {body_ratio:.2f}",
            (15, 83),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.42,
            (255, 255, 255),
        ...
        cv2.putText(
            resized_frame,
            f"Hip vertical position: {hip_y_ratio:.2f}",
            (15, 105),
            cv2.FONT_HERSHEY_SIMPLEX,
            0.42,
            (255, 255, 255),
